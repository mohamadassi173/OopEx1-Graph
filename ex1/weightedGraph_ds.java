...
public class weightedGraph_ds implements weighted_graph{
	...
	public double getW(int src ,int dest) {
		return edges.get(src).get(nodes.get(dest));
	}
	
	//// Basic constructor
	public weightedGraph_ds() {
